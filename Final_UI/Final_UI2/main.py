...
@app.route('/download')
def download():
    path = "/Users/Keerthy/Desktop/summer/new/Final_UI 2/Data/filee.pdf"
...
def getdata():
	df = pd.read_csv("/Users/Keerthy/Desktop/summer/new/Final_UI 2/Data/crunchbase-investments.csv", encoding='unicode_escape',low_memory=False)
